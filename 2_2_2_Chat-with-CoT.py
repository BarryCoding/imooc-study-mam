...
class SubmitReimbursementInput(BaseModel):
    ...
    reimbursement_level: Literal["标准", "高级", "VIP"] = Field(
        ..., description="报销级别"
    )
...
class ReActAgent:
    def __init__(self):
        ...
        self.available_tools = {
            submit_reimbursement.__name__: {
                "tool": submit_reimbursement,
                "input": SubmitReimbursementInput,
            },
            get_employee_info.__name__: {
    ...
    def process_query(self, query: str = "") -> None:
        ...
        if is_tool_calls:
            ...
            for tool_call in tool_calls_json:
                ...
                # 调用工具
                try:
                    inputs = self.available_tools[tool_name][
                        "input"
                    ].model_validate_json(tool_arguments)
...
# user prompt example1: 我想学习python， 你有什么建议吗？
# user prompt example2: 我是张三，我的工号是E12345。 今天是2025年11月18日，上周五我去北京出差，上周日才回来。 住宿费 200元，交通费 100元，餐饮费 50元，请帮我填写报销单。
